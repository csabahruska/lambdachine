#ifndef _LAMBDACHINE_CLOSURE_TYPES_H
#define _LAMBDACHINE_CLOSURE_TYPES_H

/* We use preprocessor macros instead of an enum so we can use these
   values from Haskell code.
*/
