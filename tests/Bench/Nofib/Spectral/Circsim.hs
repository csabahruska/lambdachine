{-# LANGUAGE NoImplicitPrelude, CPP, MagicHash, BangPatterns #-}
{-
...
import Prelude
import Data.List
import GHC.Base (divInt,quotInt,remInt)
import GHC.Num (quotRemInt)
#else
module Bench.Nofib.Spectral.Circsim where
...
bench = show (run 8 4000) == expected
 where
   expected = show ([F,F,F,F,F,F,F,F] : replicate 3999 [T,T,T,T,T,T,T,T])

test = show (run 8 50) == expected
 where
   expected = "[[F,F,F,F,F,F,F,F],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T],[T,T,T,T,T,T,T,T]]"
...
put xs  = Node () (put fstHalf) (put sndHalf)
        where
          (fstHalf, sndHalf) = splitAt (length xs `divInt` 2) xs

powInt :: Int -> Int -> Int
x0 `powInt` y0 | y0 < 0    = error' "Negative exponent"
        | y0 == 0   = 1
        | otherwise = f x0 y0
    where -- f : x0 ^ y0 = x ^ y
          f x y | evenInt y    = f (x * x) (y `quotInt` 2)
                | y == 1    = x
                | otherwise = g (x * x) ((y - 1) `quotInt` 2) x
          -- g : x0 ^ y0 = (x ^ y) * z
          g x y z | evenInt y = g (x * x) (y `quotInt` 2) z
                  | y == 1 = x * z
                  | otherwise = g (x * x) ((y - 1) `quotInt` 2) (x * z)
...
simulate inputs_list circuit@(size, ins, outs, states)
        = mytail (scanl' (do_cycle cpd) circuit' inputs_list)
    where
...
critical_path_depth (size, ins, outs, states)
        = maximumInt (map pathDepth states)

-- --------------------------------------------------------------------------------
-- Generate all possible input values

input_values :: Signal a => Int -> [[a]]
input_values nbits = map binary [0..(2 `powInt` nbits)-1]
    where
...
regs bits = (size, is, os, states)
    where
        size = 1+7*bits
        is = ("sto",0): zipWith ilabel [(0::Int)..] [ 7*x+1 | x <- [(0::Int)..bits-1]]
        ilabel n pid = ("x" ++ show n, pid)
        os = zipWith olabel [(0::Int)..] [ 7*x+7 | x <- [(0::Int)..bits-1]]
        olabel n pid = ("y" ++ show n, pid)
        states = sto:concat (map (reg 0) [ 7*x+1 | x <- [(0::Int)..bits-1]])
        sto = PS {      pid = 0,
                        compType  = Inp,
                        pathDepth = 0,
                        inports    = [],
